<template>
	<view>
		<u-navbar back-text="返回" back-icon-size="0" title="发布求职教程" :background="backgroundDri"
...
<script>
	export default {
		data() {
			return {
				Url1:'/static/helps/diyibu_1.png',
				Url2:'/static/helps/diyibu_2.png',
				Url3:'/static/helps/diyibu_3.png',
				Url4:'/static/helps/diyibu_4.png',
				Url5:'/static/helps/diyibu_5.png',
				backTextStyle:{
					'color':'#ffffff'
				},
			}
