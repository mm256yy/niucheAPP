<template>
	<view>
		<u-navbar back-text="返回" back-icon-size="0" title="发布求职教程" :background="backgroundDri" :back-text-style="backTextStyle"
...
<script>
	...
	export default {
		...
		data() {
			return {
				list: ['/static/helps/driver/qiuzhi/diyibu_1.png', '/static/helps/driver/qiuzhi/diyibu_2.png',
					'/static/helps/driver/qiuzhi/diyibu_3.png', '/static/helps/driver/qiuzhi/diyibu_4.png',
