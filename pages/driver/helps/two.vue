<template>
	<view>
		<u-navbar back-text="返回" back-icon-size="0" title="发布求租教程" :background="backgroundDri"
...
<script>
	export default {
		data() {
			return {
				Url1:'/static/helps/fabu_diyibu_1.png',
				Url2:'/static/helps/fabu_diyibu_2.png',
				Url3:'/static/helps/fabu_diyibu_3.png',
				Url4:'/static/helps/fabu_diyibu_4.png',
				Url5:'/static/helps/fabu_diyibu_5.png',
				backTextStyle:{
					'color':'#ffffff'
				},
			}
