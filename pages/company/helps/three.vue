...
<script>
	export default {
		data() {
			return {
				Url1:'/static/helps/siji_diyibu_1.png',
				Url2:'/static/helps/siji_diyibu_2.png',
				Url3:'/static/helps/siji_diyibu_3.png',
				Url4:'/static/helps/siji_diyibu_4.png',
				Url5:'/static/helps/siji_diyibu_5.png',
				backTextStyle:{
					'color':'#ffffff'
				},
			}
