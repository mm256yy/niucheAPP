<template>
	<view>
		<u-navbar back-text="返回" back-icon-size="0" title="人员招募教程" :background="backgroundCom"
	...
	<script>
		...
		export default {
			...
			data() {
				return {
					list: ['/static/helps/company/zhaopin/siji_diyibu_1.png', '/static/helps/company/zhaopin/siji_diyibu_2.png',
						'/static/helps/company/zhaopin/siji_diyibu_3.png', '/static/helps/company/zhaopin/siji_diyibu_4.png',
