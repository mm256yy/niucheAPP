<template name="aui-poster">
	...
	>
		...
		<view class="aui-poster-main">
			...
			<img class="aui-poster-close" mode="widthFix" data-type="close" @click.stop="_clickFn($event)" src="http://niuche-default.neocab.cn/guanbi.png">
		</view>
	</view>
</template>
...
<style>
	...
	.aui-poster-main{width: 76%; opacity: 0; position: fixed; top: -50vh; left: 10%; z-index: 999;}
